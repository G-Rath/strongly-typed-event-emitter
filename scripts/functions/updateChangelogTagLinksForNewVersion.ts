 ...
 */
const buildCompareUrl = (repoUrl: string, newVersionTag: string, lastVersionTag: string): string => {
 ...
 * @throws {Error} when the repo host isn't supported
 */
const getOldVersionTagFromUnreleasedLink = (unreleasedLinkUrl: string): string => {
 ...
 */
const getUnreleasedCompareUrl = (changelog: string, gitUrl: string): string => {
 ...
 */
export default (newVersionString: string, gitRepoUrl: string, changelogPath: string): void => {
