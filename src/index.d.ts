...
export declare class StronglyTypedEventEmitter<TEventMap extends EventMap> extends EventEmitter {
  ...
  public addListener<K extends keyof TEventMap>(event: K, listener: (event: TEventMap[K]) => void): this;
  ...
  public prependListener<K extends keyof TEventMap>(event: K, listener: (event: TEventMap[K]) => void): this;

  public prependOnceListener<K extends keyof TEventMap>(event: K, listener: (event: TEventMap[K]) => void): this;

  public removeListener<K extends keyof TEventMap>(event: K, listener: (event: TEventMap[K]) => void): this;
  ...
  public listeners<K extends keyof TEventMap>(event: K): Array<((event: TEventMap[K]) => void) | Function>;

  public rawListeners<K extends keyof TEventMap>(event: K): Array<((event: TEventMap[K]) => void) | Function>;
